...
The standard Scala library defines a trait \lstinline@scala.Dynamic@, which enables dynamic member selection on instances of this trait.
...
\code{scala.App} that defines an empty inherited \code{main} method.
