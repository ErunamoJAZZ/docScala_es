...
Scala integra sin irregularidades programación orientada a objetos y
funcional. Se diseñó para expresar patrones de programación comunes
en una manera concisa, elegante y de tipado seguro. Scala introduce
varias constructos de lenguaje innovadores. Por ejemplo:
\begin{itemize}
\item
...
y los {\em Frameworks} se pueden utilizar sin código pegamento o
...
Los siguientes capítulos intrudcen los constructos del lenguaje Scala
...
informal tiene la intención de completarse por el Manual de Referencia
...
Programs''\cite{abelson-sussman:structure} de Abelson y Sussman.
Muchos de sus ejemplos y ejercicios también están presentes aquí. Por
supuesto, trabajar con el lenguaje tiene en caa caso se ha cambiado de
