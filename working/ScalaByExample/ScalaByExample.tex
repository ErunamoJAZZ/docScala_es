...
\chapter{\label{chap:intro}Introducción}

Scala integra sin irregularidades la programación orientada a objetos y
la programación funcional. Se diseñó para expresar patrones de programación comunes
de una manera concisa, elegante y con tipado seguro. También introduce
varias innovaciones en la construcción del lenguaje. Por ejemplo:
\begin{itemize}
\item
Conceptos unificadores de tipos abstractos y composición de mezcla del
los sistemas de objeto y módulo.
\item
Los patrones concordantes sobre jerarquía unifican cómo tener acceso a
información funcional y orientada a objetos. Esto simplifica enormemente
el procesar árboles XML.
\item
Una sintaxis flexible y un sistema de tipado que habilitan la
construcción de bibliotecas avanzadas y nuevos lenguajes de dominio
específico (DSL, por sus siglas en inglés, {\em Domain Specific
Language}).
\end{itemize}
Al mismo tiempo, Scala es compatible con Java. Las bibliotecas de Java
y los {\em Frameworks} escritos en el, se pueden utilizar sin código 
pegamento o declaraciones adicionales.

Este documento introduce Scala de una manera informal, mediante una
secuencia de ejemplos.

Los capítulos~\ref{chap:example-one} y \ref{chap:example-auction}
enfatizan algunas de las características que hacen a Scala interesante.
Los siguientes capítulos introducen los constructos del lenguaje Scala
de manera más cuidadosa, comenzando con expresiones y funciones simples,
y trabajando sobre y mediante objetos y clases, listas y {\em streams}, 
estados mutables, concordancia de patrones, a ejemplos más complejos que
muestran técnicas de programación interesantes. La presente exposición
...
\paragraph{Reconocimiento}
Estamos en gran deuda con el maravilloso libro
“Structure and Interpretation of Computer Programs''
\cite{abelson-sussman:structure} de Abelson y Sussman.
Muchos de sus ejemplos y ejercicios también están presentes aquí. Por
supuesto, al trabajar con el lenguaje se ha cambiado en cada caso de
Scheme a Scala. Además, los ejemplos hacen uso de los constructos
orientados a objetos donde es apropiado.
...
\chapter{Implementando Tipos Abstractos: Arboles de Búsqueda}
