...
arreglo original para los cuales la función de predicado es
{\em true}. El método \code{filter} de un objeto de tipo
...
Aquí tenemos un ejemplo que muestra un área de aplicación para la cual Scala es particularmente bueno. Considere la tarea de implementar un servicio electrónico de subastas. Usamos un modelo de procesamiento de actores (en inglés, {\em actor process model}) al estilo Erlang para implementar a los participantes de la subasta. Los “actores” son objetos que pueden enviar mensajes. Cada actor tiene una “bandeja de entrada” donde llegan los mensajes, que son representados como una cola. Trabaja secuencialmente la cola de mensajes en su bandeja de entrada, o realiza la búsqueda de patrones en los mensajes.
...
As a first step, we define the messages that are exchanged during an auction. There are two abstract base classes
