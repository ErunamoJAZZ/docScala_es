...
funciones donde estan incluídas. Por ejemplo, el nombre del arreglo 
...
pero escrito esta vez en estilo funcional.
...
el algoritmo imperativo; el llamado posterior, parte el arreglo en dos
...
el arreglo que le llega como argumento sin ningun cambio. 
La implementación funcional requiere más memoria transitiva que
la imperativa.

La implementación imperativa hace parecer a Scala como si fuera
...
ejemplo son simples métodos de biblioteca de una
...
arreglo original para el cual la función de predicado es
...
la cual hace al argumento faltante explícito es
~\lstinline@x => pivot > x@.
...
incluso se espera) de reconocer el caso especial al llamar al método
...
regresan un valor explícito necesitan un ``='' antes de definir su cuerpo
o de definir sus expresiones.
